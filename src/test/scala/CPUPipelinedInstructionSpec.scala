...
class CPUPipelinedInstructionSpec
  ...
  behavior of "CPUPipelinedInstructions"

  it should "validate ADD/ADDI/SUB instructions with nops" in {
    val prog = """
      addi x1, x1, 1
      addi x2, x2, 1
      nop
  ...
  it should "validate logic instructions" in {
    val prog = """
      andi x1, x0, 1
      nop
      nop
  ...
  it should "validate compare instructions" in {
    val prog = """
      slti x1, x0, 1
      nop
      nop
