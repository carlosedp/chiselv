  ...
  val signals =
    ListLookup(
      ...
      Array(
        ...
        BitPat("b?????????????????000?????0010011")  -> List(INST_I,      ADD,  true.B,  false.B, true.B,   false.B,  false.B,  false.B), // ADDI
        ...
        BitPat("b0000000??????????001?????0010011")  -> List(INST_I,      SLL,  true.B,  false.B, true.B,   false.B,  false.B,  false.B), // SLLI
        BitPat("b0100000??????????101?????0110011")  -> List(INST_R,      SRL,  true.B,  false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b0000000??????????101?????0010011")  -> List(INST_I,      SRL,  true.B,  false.B, true.B,   false.B,  false.B,  false.B), // SRLI
        BitPat("b0100000??????????101?????0110011")  -> List(INST_R,      SRA,  true.B,  false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b0100000??????????101?????0010011")  -> List(INST_I,      SRA,  true.B,  false.B, true.B,   false.B,  false.B,  false.B), // SRAI
        // Logical
        BitPat("b0000000??????????100?????0110011")  -> List(INST_R,      XOR, true.B,   false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b?????????????????100?????0010011")  -> List(INST_I,      XOR, true.B,   false.B, true.B,   false.B,  false.B,  false.B), // XORI
        BitPat("b0000000??????????110?????0110011")  -> List(INST_R,       OR, true.B,   false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b?????????????????110?????0010011")  -> List(INST_I,       OR, true.B,   false.B, true.B,   false.B,  false.B,  false.B), // ORI
        BitPat("b0000000??????????111?????0110011")  -> List(INST_R,      AND, true.B,   false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b?????????????????111?????0010011")  -> List(INST_I,      AND, true.B,   false.B, true.B,   false.B,  false.B,  false.B), // ANDI
        // Compare
        BitPat("b0000000??????????010?????0110011")  -> List(INST_R,     SLT,  true.B,   false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b?????????????????010?????0010011")  -> List(INST_I,     SLT,  true.B,   false.B, true.B,   false.B,  false.B,  false.B), // SLTI
        BitPat("b0000000??????????011?????0110011")  -> List(INST_R,    SLTU,  true.B,   false.B, false.B,  false.B,  false.B,  false.B),
        BitPat("b?????????????????011?????0010011")  -> List(INST_I,    SLTU,  true.B,   false.B, true.B,   false.B,  false.B,  false.B), // SLTIU
        // Branches
        ...
        BitPat("b?????????????????000?????1101111")  -> List(INST_I,    JALR, false.B,   false.B, true.B,    true.B,  false.B,  false.B),
        // Sync
