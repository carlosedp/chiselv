...
# LED2_FPGA J26
set_property LOC J26 [get_ports led0]
set_property IOSTANDARD LVCMOS33 [get_ports {led0}]

# LED3_FPGA H26
set_property LOC H26 [get_ports GPIO0[0]]
...
set_property IOSTANDARD LVCMOS33 [get_ports {reset}]
# SW3
set_property LOC A20 [get_ports GPIO0[7]]
...
##USB-UART Interface
set_property LOC B12 [get_ports UART0_tx]
set_property IOSTANDARD LVCMOS33 [get_ports {UART0_tx}]
set_property LOC B11 [get_ports UART0_rx]
